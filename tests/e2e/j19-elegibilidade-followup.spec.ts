/**
 * J19.12 — O FOLLOW-UP AUTOMÁTICO RESPEITA O GATE.
 *
 ...
 *   E2E_PORT=3001 pnpm exec playwright test tests/e2e/j19-elegibilidade-followup.spec.ts
 */
...
test.describe("J19.12 — o follow-up automático respeita o gate", () => {
