...
export const DICIONARIO: Traducoes = {
  ...
  "Revise o ritmo e inicie a campanha quando estiver pronto.": { es: "Revisa el ritmo e inicia la campaña cuando esté listo." },
  ...
  // ROTULO_DO_AUTOR (lib/agenda/tipos.ts) — quem marcou o compromisso.
  "Marcado pela equipe": { es: "Programado por el equipo" },
  "Marcado pelo atendente de IA": { es: "Programado por el agente de IA" },
  "Marcado pelo sistema": { es: "Programado por el sistema" },
  "Marcado pelo próprio cliente": { es: "Programado por el propio cliente" },
  "Veio da agenda conectada": { es: "Vino de la agenda conectada" },
  // ROTULO_DA_SITUACAO_DA_CONEXAO (lib/agenda/tipos.ts) — estado do OAuth do Google.
